...
public class StudentManagementSystemVersionIiApplication {
	...
	@Bean
	public CommandLineRunner demo(tblAttend_Student_Repository attend_student_repo,tblDepartment_Repository department_repo,tblCourses_Repository course_repo,tblStudentGrades_Repository grade_repo,tblFaculty_Repository faculty_repo,tblStudents_Repository student_repo,semester_Repository semester_repo,tblGPA_Repository gpa_repo,tblStudentUser_Repository studentuser_repo,tblFacultyUser_Repository facultyuser_repo,tblAdminUser_Repository adminuser_repo,tblApplicantUser_Repository applicantuser_repo)
	{
		...
		// 5. TBL STUDENTS
		tblStudents student_obj_one = service.createtblStudents("thanthtetmyet1994@gmail.com","Thant", "Myet", "Htet", "male", "26/8/1994", "Master", "Clementi", "83816401", "thanthtetmyet1994@gmail.com", semester_obj_two, gpa_obj_one);
		tblStudents student_obj_two = service.createtblStudents("wityimon1995@gmail.com","Ma", "Mon", "Wityi", "female", "21/5/1995", "Master", "PyinOoLwin", "095127360", "wityimon1995@gmail.com", semester_obj_one, gpa_obj_three);
		tblStudents student_obj_three = service.createtblStudents("kaungyazar1994@gmail.com","Kaung", "Zar", "Yar", "male", "2/3/1994", "Bachelor", "Yangon", "095024857", "kaungyarzar1994@gmail.com", semester_obj_three, gpa_obj_three);
		...
		// 11. TBL COURSE
		 ...
		 tblCourses course_obj_one = service.createtblCourses(013, "BIGDATA", 4,
		 department_obj_one); tblCourses course_obj_two =
		 service.createtblCourses(055, "NLP", 5, department_obj_one); tblCourses
		 course_obj_three = service.createtblCourses(005, "BitCoin", 8,
		 department_obj_one); tblCourses course_obj_four =
		 service.createtblCourses(31, "Assembly", 5, department_obj_two);
		 tblCourses course_obj_five = service.createtblCourses(5, "MATLAB", 4,
		 department_obj_two); tblCourses course_obj_six =
		 service.createtblCourses(004, "C", 5, department_obj_two); tblCourses
		 course_obj_seven = service.createtblCourses(035, "Chemistry", 5,
		 department_obj_three); tblCourses course_obj_eight =
		 service.createtblCourses(013, "Nano", 4, department_obj_three);
		 tblCourses course_obj_nine = service.createtblCourses(006, "Micro", 5,
		...
		tblStudentGrades studentgrades_obj_one = service.createtblStudentGrades("A", 2, 2, course_obj_one, student_obj_three);
		tblStudentGrades studentgrades_obj_two = service.createtblStudentGrades("A", 5, 1, course_obj_two, student_obj_two);
		tblStudentGrades studentgrades_obj_three = service.createtblStudentGrades("B", 4, 3, course_obj_three, student_obj_one);
		tblStudentGrades studentgrades_obj_four = service.createtblStudentGrades("B", 5, 1, course_obj_two, student_obj_one);
		tblStudentGrades studentgrades_obj_five = service.createtblStudentGrades("C", 4, 1, course_obj_one, student_obj_one);
