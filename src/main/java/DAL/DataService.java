...
// Ten Table
public tblStudents createtblStudents(String studentid,String firstName, String lastName, String middelName, String gender, String birthDate,String degree, String address, String mobile, String email,semester sample_semester,tblGPA sample_gpa)
{
...
// Twelve Table
public tblCourses createtblCourses(int coursecode, String coursename, int courseunit,tblDepartment sample_department)
{
...
// Thirteen Table
public tblStudentGrades createtblStudentGrades(String grade, int semester, int facultytypeid,tblCourses sample_course,tblStudents sample_students)
{
	tblStudentGrades sample = new tblStudentGrades(grade,semester,facultytypeid);
